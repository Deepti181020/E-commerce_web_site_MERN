  ...
  return (
    <div className="hero bg-gradient-to-b from-[#eaebef] via-[#f4ebe7] to-[#b0a8a6] flex flex-row sm:flex-row items-center justify-center p-4 lg:p-0">
      <div className="hero-left flex-1 flex flex-col items-center sm:items-start text-center sm:text-left gap-2 sm:gap-2 sm:pl-4 lg:pl-[180px]">
        ...
        <div className="hero-latest-btn flex items-center justify-center sm:justify-center gap-3 w-[180px] sm:w-[250px] lg:w-[310px] h-[45px] sm:h-[60px] lg:h-[70px] rounded-full bg-[#1d1d30] text-white mt-4 sm:mt-5 lg:mt-6 font-medium text-[16px] sm:text-[20px] lg:text-[22px] cursor-pointer">
